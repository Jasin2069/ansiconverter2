Public Module ANM
    ...
    Public Function ProcessANSIAnimationFile(ByVal sFile As String, ByVal sOutFile As String, Optional ByVal aFile As Byte() = Nothing) As String()
        ...
        sJS = ByteArrayToStr(My.Resources.ANSIJS, FFormats.us_ascii)
        'sJS = ByteArrayToStr(My.Resources.ANSIJS2, FFormats.us_ascii)

        sJS = CutorSandR(sJS, "//VARDEFSTART", "//VARDEFEND", "I", "I", "C", 1)
        sJS = CutorSandR(sJS, "//CALLSTART", "//CALLEND", "I", "I", "C", 1)
    ...
    Function HTMLUniEncode(ByVal iChr As Integer) As String
        If aSpecH(iChr) <> "" Then
            Return aSpecH(iChr)
        Else
            If Int(aUniCode(iChr)) <> Int(iChr) Or iChr = 44 Then
                Return "&#" & aUniCode(iChr) & ";"
            Else
                If iChr = 92 Then
